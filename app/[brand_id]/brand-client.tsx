      ...
      >
        ...
        <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, visible: { opacity: 1, scale: 1 } }} className="bento-item col-span-12 md:col-span-8 min-h-[60vh] flex flex-col md:flex-row overflow-hidden p-0 bg-zinc-900/50 border border-zinc-800 relative group">
          <div className="flex-1 p-8 md:p-12 flex flex-col justify-center z-10">
            ...
            <h2 className="text-5xl md:text-6xl font-bold uppercase tracking-tighter mb-6 text-white leading-tight">
              {brand.offer}
            </h2>
        ...
        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="bento-item col-span-12 md:col-span-4 flex flex-col justify-between bg-zinc-900/50 border border-zinc-800 p-8 hover:border-primary/50 transition-colors">
          <div className="flex items-center gap-2 font-mono text-sm uppercase tracking-widest text-primary mb-4">
            <Leaf className="h-5 w-5" />
            Environmental Impact
          </div>
          <div>
            <p className="text-5xl font-bold tracking-tighter mb-4 text-white">
              {brand.impact}
            </p>
        ...
        {/* Direct to Buy */}
        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="bento-item col-span-12 md:col-span-6 flex flex-col justify-between group cursor-pointer bg-zinc-900 border border-zinc-800 hover:bg-white hover:text-black transition-all duration-300 p-8">
        ...
        <Dialog>
          <DialogTrigger
            render={
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="bento-item col-span-12 md:col-span-6 flex flex-col justify-between group cursor-pointer bg-primary text-primary-foreground border border-primary hover:bg-white hover:text-black transition-all duration-300 p-8 overflow-hidden relative">
                <h3 className="text-3xl font-bold uppercase tracking-tighter mb-8 relative z-10 group-hover:text-black">
                  Claim Your Drop
                </h3>
          ...
          />
          <DialogContent className="sm:max-w-md border-zinc-800 bg-zinc-950 text-white rounded-2xl overflow-hidden p-0">
            <div className="p-6 md:p-8 relative">
                <DialogHeader className="mb-6">
                  <DialogTitle className="text-3xl font-bold tracking-tighter uppercase text-white">
                    Get The Drop
                  </DialogTitle>
                </DialogHeader>
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <Button
                        type="submit"
                        className="rounded-xl h-14 bg-primary text-primary-foreground hover:bg-white hover:text-black font-bold uppercase tracking-widest relative overflow-hidden group transition-all"
                        >
